 ...
 */
class LiveInvoiceTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var API
     */
    ...
    public function testCreateInvoiceFromOrder()
    {
        ...
        if ($response['code'] != 201) {
            throw new Exception("CREATEINVOICEERROR", "Could not create invoice");
        }
    ...
    /**
     * Creates a client + Address + order, copies the order to an invoice and prints it
     * Watch it all data is beeing deleted at the end of the test!!!
     * @group live-invoice
     * @covers API::request
     */
    public function testPrintInvoice()
    {
        ...
        $data = array(
            'template_id' => 'aLb3zogCir4BaAabxfpGMl',   // add default template on the dev server
            'base64' => '1'
        );
